...
import StyledAccordion from 'components/common/StylesAccordian';
...
export default function SettingsScreen() {
  ...
  //  GET EXPORT OPTION ICON
  const getThemeIcon = () => {
    switch (theme) {
      case 'Light':
        return <MaterialIcons name="sunny" size={24} color="black" />;

      case 'Dark':
        return <AntDesign name="moon" size={24} color="black" />;
  ...
  const getExportIcon = () => {
    switch (exportFormat) {
      case 'CSV':
        return <FontAwesome6 name="file-csv" size={24} color="black" />;

      case 'JSON':
        return <MaterialIcons name="data-object" size={24} color="black" />;

      case 'XML':
        return <MaterialIcons name="code" size={24} color="black" />;
  ...
  return (
    <ScrollView className="flex-1 bg-background">
      <View className="p-400">
          ...
          <View className="flex-row items-center justify-between border-b border-grey1 p-350">
            ...
            <View className="relative">
              <TouchableOpacity
                ...
                {getThemeIcon()}
                <Text className="text-200 font-medium text-foreground">{theme}</Text>
                <Ionicons
                ...
                <View
                  ...
                  {themes.map((t, index) => (
                    <TouchableOpacity
                      ...
                      className={`flex-row items-center justify-center gap-300 px-400 py-300 ${index < themes.length - 1 ? 'border-b border-grey1' : ''} ${index === 0 ? 'rounded-t-400' : ''} ${index === themes.length - 1 ? 'rounded-b-400' : ''}`}>
          ...
          <View className="flex-row items-center justify-between p-350">
            ...
            <View className="relative">
              <TouchableOpacity
                ...
                <Text className="text-200 font-medium text-foreground">{currency}</Text>
                <Ionicons
                ...
                <View
                  ...
                  {currencies.map((c, index) => (
                    <TouchableOpacity
                      ...
                      className={`flex-row items-center justify-center gap-300 px-400 py-300 ${index < currencies.length - 1 ? 'border-b border-grey1' : ''} ${index === 0 ? 'rounded-t-400' : ''} ${index === currencies.length - 1 ? 'rounded-b-400' : ''}`}>
        ...
        <StyledAccordion title="Export & Import">
          {/* Export All Data Row */}
          <View className="flex-row items-center justify-between border-b border-grey1 p-350">
                ...
                <View
                  ...
                  {formats.map((f, index) => (
                    <TouchableOpacity
                      ...
                      className={`flex-row items-center justify-center gap-300 px-400 py-300 ${index < formats.length - 1 ? 'border-b border-grey1' : ''} ${index === 0 ? 'rounded-t-400' : ''} ${index === formats.length - 1 ? 'rounded-b-400' : ''}`}>
        ...
        <StyledAccordion title="Security" titleVariant="accent">
          {/* Delete All Data Row */}
          <View className="flex-row items-center justify-between p-350">
